...
const CreateTask = ({ 
  ...
  const { projects, categories, employees, createTask, loading } = useProject();
  ...
  const tagSuggestions = [
    ...
    'Bug Fix', 'Feature', 'Enhancement', 'Research', 'Documentation'
  ];
      ...
      case 0:
        return (
          <Box sx={{ mt: 2 }}>
            ...
            {formData.projectId && (
              <Card sx={{ mt: 2, backgroundColor: 'rgba(139, 126, 200, 0.05)' }}>
                <CardContent sx={{ p: 2 }}>
              ...
              <Card sx={{ mt: 2, backgroundColor: 'rgba(139, 126, 200, 0.05)' }}>
                <CardContent sx={{ p: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    <Avatar sx={{ bgcolor: 'primary.main' }} src={formData.assignedTo.photoURL}>
          ...
          <Box sx={{ mt: 2 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <Card elevation={0} sx={{ backgroundColor: 'rgba(139, 126, 200, 0.05)' }}>
                  <CardContent>
                    <Typography variant="subtitle2" color="text.secondary" gutterBottom>
                      Basic Information
                    </Typography>
                    <Typography variant="body2"><strong>Name:</strong> {formData.name}</Typography>
                    <Typography variant="body2"><strong>Project:</strong> {getSelectedProject()?.name}</Typography>
                ...
                <Card elevation={0} sx={{ backgroundColor: 'rgba(139, 126, 200, 0.05)' }}>
                  <CardContent>
                    ...
                    <Typography variant="body2">
                      <strong>Priority:</strong> {priorityOptions.find(p => p.value === formData.priority)?.label}
                    </Typography>
                    <Typography variant="body2">
                      <strong>Status:</strong> {statusOptions.find(s => s.value === formData.status)?.label}
                    </Typography>
                    {formData.assignedTo && (
                      <Typography variant="body2">
                    ...
                    {formData.dueDate && (
                      <Typography variant="body2">
                        <strong>Due:</strong> {formData.dueDate.toLocaleDateString()}
                      </Typography>
                    )}
                  </CardContent>
                </Card>
            ...
            {formData.description && (
              <Card elevation={0} sx={{ mt: 2, backgroundColor: 'rgba(139, 126, 200, 0.05)' }}>
                <CardContent>
                  <Typography variant="subtitle2" color="text.secondary" gutterBottom>
                    Description
                  </Typography>
  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ p: 0 }}>
        <Grid container>
          {/* Stepper */}
          <Grid item xs={12} md={4} sx={{ borderRight: { md: '1px solid rgba(0,0,0,0.12)' } }}>
            <Box sx={{ p: 3 }}>
                  ...
                  <Step key={step.label}>
                    <StepLabel
                      StepIconComponent={() => (
                        ...
                        >
                          {index < activeStep ? <CheckCircle sx={{ fontSize: 18 }} /> : step.icon}
                        </Box>
                      )}
                    >
